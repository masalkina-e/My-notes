...
function App() {
  ...
  function editNote(id) {
    toggleEditModal()
    let newNote = notes.find((newNote) => {
    ...
    <div>
      <header className="bg-orange-100">
        <div className="mx-auto mb-28 px-40">
          <button onClick={toggleModal} className="border-0 bg-orange-100 cursor-pointer py-5 px-0 text-3xl text-orange-600"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10">
      ...
      <div className='mx-auto mb-28 px-40'>
        ...
        {isOpenEditModal === true && <ModalEdit toggleEditModal={toggleEditModal} noteForEdit={noteForEdit} renderEditNotes={renderEditNotes}/>}
